# Erdős Distinct Distances (n=93) — Canonical Lane Mathlib

Mathlib-backed Canonical Lane formalization package for the Erdős Distinct Distances (n=93).

## Clean-clone replay

```bash
git clone https://github.com/HautevilleHouse/erdos-dist-93-mathlib.git
cd erdos-dist-93-mathlib
lake exe
lake build
```
